...
# Save output
ggsave("outputs/heat_alert_1.png", width = 250, height = 200, units = "mm")
...
# Save output
ggsave("outputs/heat_alert_2.png", width = 250, height = 200, units = "mm")
...
# Save output
ggsave("outputs/heat_alert_3.png", width = 250, height = 200, units = "mm")
...
# Save output
ggsave("outputs/heat_alert_4.png", width = 250, height = 200, units = "mm")
